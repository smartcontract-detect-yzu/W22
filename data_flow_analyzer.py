...
from contract_analyze import ContractInfo
from function_analyze import FunctionInfo
...
class DataFlowAnalyzer:
    def __init__(self, function_info: FuntionInfo, contract_info: ContractInfo):

        self.function_info = function_info
        self.contract_info = contract_info

        self.data_flow_edges = None
        self.data_flow_map = None

        self.data_dependency_edges = None  # 数据依赖
