//SourceUnit: zero2hero55.sol

pragma solidity 0.5.9;

contract Zero2Hero55  {
    ...
    uint REGESTRATION_FESS = 60;
    uint pool1_price = 20;
    uint pool2_price = 200;
    uint pool3_price = 400;
    uint pool4_price = 800;
    uint pool5_price = 1200;
 ...
 function Trans(address payable _address, uint _amounts) public  returns(bool){
    ...
    function buyPools(uint _level) public payable{
        require(_level > 1 && _level < 7, "Invalid Level");
        if(_level == 2){
