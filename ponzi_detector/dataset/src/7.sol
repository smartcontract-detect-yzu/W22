...
contract FastPool {
    ...
    uint REGESTRATION_FESS = 45 ;
    uint pool1_price = 15 ;
    uint pool2_price = 45 ;
    uint pool3_price = 100 ;
    uint pool4_price = 200 ;
    uint pool5_price = 300 ;
    uint pool6_price = 500 ;
    uint pool7_price = 1000 ;
    uint pool8_price = 2000 ;
    uint pool9_price = 4000 ;
    uint pool10_price = 8000 ;
    uint pool11_price = 16000 ;
    uint pool12_price = 32000 ;
    uint pool13_price = 64000 ;
    ...
    constructor() public {
        ...
        LEVEL_PRICE[9] = 4000 ;
        LEVEL_PRICE[10] = 8000 ;
        LEVEL_PRICE[11] = 16000 ;
        LEVEL_PRICE[12] = 32000 ;
        LEVEL_PRICE[13] = 64000 ;
