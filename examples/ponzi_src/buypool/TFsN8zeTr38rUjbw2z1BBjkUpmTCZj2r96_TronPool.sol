...
contract TronPool {
    ...
    uint REGESTRATION_FESS = 135;
    uint pool1_price = 40;
    uint pool2_price = 100;
    uint pool3_price = 200;
    uint pool4_price = 400;
    uint pool5_price = 800;
    uint pool6_price = 1600;
    uint pool7_price = 3200;
    uint pool8_price = 6400;
    uint pool9_price = 12800;
    ...
    function buyPool2(address sender,uint value) internal {
        ...
        require(value == 105, 'Incorrect Value');
    ...
    function buyPool3(address sender,uint value) internal {
        ...
        require(value == 210, 'Incorrect Value');
    ...
    function buyPool4(address sender,uint value) internal {
        ...
        require(value == 420, 'Incorrect Value');
...
FeeAddress.transfer((pool4_price.mul(5)).div(100));
    ...
    function buyPool5(address sender,uint value) internal {
        ...
        require(value == 840, 'Incorrect Value');
    ...
    function buyPool6(address sender,uint value) internal {
        ...
        require(value == 1680, 'Incorrect Value');
    ...
    function buyPool7(address sender,uint value) internal {
        ...
        require(value == 3360, 'Incorrect Value');
    ...
    function buyPool8(address sender,uint value) internal {
        ...
        require(value == 6720, 'Incorrect Value');
    ...
    function buyPool9(address sender,uint value) internal {
        ...
        require(value == 13440, 'Incorrect Value');
