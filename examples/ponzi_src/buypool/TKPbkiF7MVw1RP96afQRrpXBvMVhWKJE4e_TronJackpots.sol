...
contract TronJackpots {
	...
	uint sponsorincome = 5;
	
    uint pool1_price = 200;
    uint pool2_price = 300;
    uint pool3_price = 500;
    uint pool4_price = 900;
    uint pool5_price = 1700;
    uint pool6_price = 3300;
    uint pool7_price = 6500;
    uint pool8_price = 12900;
    uint pool9_price = 25700;
    uint pool10_price = 51300;
    
    uint pool1_reentry_income = 100; 
    uint pool2_reentry_income = 300; 
    uint pool3_reentry_income = 700; 
    uint pool4_reentry_income = 1500; 
    uint pool5_reentry_income = 3100; 
    uint pool6_reentry_income = 6300; 
    uint pool7_reentry_income = 12700; 
    uint pool8_reentry_income = 25500; 
    uint pool9_reentry_income = 51100; 
    uint pool10_reentry_income = 102300; 
    
    uint pool1_upgrade_income = 0; 
    uint pool2_upgrade_income = 0; 
    uint pool3_upgrade_income = 100; 
    uint pool4_upgrade_income = 300; 
    uint pool5_upgrade_income = 700; 
    uint pool6_upgrade_income = 1500; 
    uint pool7_upgrade_income = 3100; 
    uint pool8_upgrade_income = 6300; 
    uint pool9_upgrade_income = 12700; 
    uint pool10_upgrade_income = 25500; 
    
    uint pool1_exit_income = 300; 
    uint pool2_exit_income = 600; 
    uint pool3_exit_income = 1200; 
    uint pool4_exit_income = 2400; 
    uint pool5_exit_income = 4800; 
    uint pool6_exit_income = 9600; 
    uint pool7_exit_income = 19200;  
    uint pool8_exit_income = 38400;  
    uint pool9_exit_income = 76800;  
    uint pool10_exit_income = 153600;  
