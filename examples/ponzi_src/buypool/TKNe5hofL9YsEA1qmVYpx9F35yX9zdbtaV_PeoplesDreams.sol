...
contract PeoplesDreams {
   ...
   uint REGESTRATION_FESS=1500;
   uint comisionSpo=400;
   uint pool1_price=1500 ;
   uint pool2_price=1400;
   uint pool3_price=2800;
   uint pool4_price=5600;
   uint pool5_price=11200;
   uint pool6_price=22400;
   uint pool6_dif = 20900;
