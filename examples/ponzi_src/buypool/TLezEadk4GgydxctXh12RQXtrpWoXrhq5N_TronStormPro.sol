...
contract TronStormPro {
   ...
   uint public REGESTRATION_FEES=500;
   uint public pool1_price=2000;
   uint public pool2_price=5000;
   uint public pool3_price=10000;
   uint public pool4_price=20000;
   uint public pool5_price=50000;
   uint public pool6_price=100000;
   uint public pool7_price=200000;
   uint public pool8_price=400000;
   uint public pool9_price=500000;
   uint public pool10_price=1000000;
    ...
    event getPoolPayment(address indexed _user,address indexed _receiver, uint _level,uint amount,uint _time);
     ...
     TronStorm tsObj;
      ...
      constructor(address contractAddr) public {
        ...
        LEVEL_PRICE[1] = 100;  // 20
        LEVEL_PRICE[2] = 50; // 10
        LEVEL_PRICE[3] = 25; // 5
        LEVEL_PRICE[4] = 2; // 0.5
        unlimited_level_price_reg = 1 ; // 0.2
        
        LEVEL_PRICE_POOL1[1] = 40;
        LEVEL_PRICE_POOL1[2] = 20;
        LEVEL_PRICE_POOL1[3] = 10;
        LEVEL_PRICE_POOL1[4] = 1;
        unlimited_level_price_pool1 = 1 ;
        
        LEVEL_PRICE_POOL2[1] = 100;
        LEVEL_PRICE_POOL2[2] = 50;
        LEVEL_PRICE_POOL2[3] = 25;
        LEVEL_PRICE_POOL2[4] = 2;
        unlimited_level_price_pool2 = 1 ;
        
        LEVEL_PRICE_POOL3[1] = 200;
        LEVEL_PRICE_POOL3[2] = 100;
        LEVEL_PRICE_POOL3[3] = 50;
        LEVEL_PRICE_POOL3[4] = 5;
        unlimited_level_price_pool3 = 2 ;
        
        LEVEL_PRICE_POOL4[1] = 400;
        LEVEL_PRICE_POOL4[2] = 200;
        LEVEL_PRICE_POOL4[3] = 100;
        LEVEL_PRICE_POOL4[4] = 10;
        unlimited_level_price_pool4 = 4 ;
        
        LEVEL_PRICE_POOL5[1] = 1000;
        LEVEL_PRICE_POOL5[2] = 500;
        LEVEL_PRICE_POOL5[3] = 250;
        LEVEL_PRICE_POOL5[4] = 25;
        unlimited_level_price_pool5 = 10 ;
        
        LEVEL_PRICE_POOL6[1] = 2000;
        LEVEL_PRICE_POOL6[2] = 1000;
        LEVEL_PRICE_POOL6[3] = 500;
        LEVEL_PRICE_POOL6[4] = 50;
        unlimited_level_price_pool6 = 20 ;
        
        LEVEL_PRICE_POOL7[1] = 4000;
        LEVEL_PRICE_POOL7[2] = 2000;
        LEVEL_PRICE_POOL7[3] = 1000;
        LEVEL_PRICE_POOL7[4] = 100;
        unlimited_level_price_pool7 = 40 ;
        
        LEVEL_PRICE_POOL8[1] = 8000;
        LEVEL_PRICE_POOL8[2] = 4000;
        LEVEL_PRICE_POOL8[3] = 2000;
        LEVEL_PRICE_POOL8[4] = 200;
        unlimited_level_price_pool8 = 80 ;
        
        LEVEL_PRICE_POOL9[1] = 10000;
        LEVEL_PRICE_POOL9[2] = 5000;
        LEVEL_PRICE_POOL9[3] = 2500;
        LEVEL_PRICE_POOL9[4] = 250;
        unlimited_level_price_pool9 = 100 ;
        
        LEVEL_PRICE_POOL10[1] = 20000;
        LEVEL_PRICE_POOL10[2] = 10000;
        LEVEL_PRICE_POOL10[3] = 5000;
        LEVEL_PRICE_POOL10[4] = 500;
        unlimited_level_price_pool10 = 200 ;
