...
contract TronInfinity {
    ...
    uint256[5] public REFERRAL_PERCENTS = [100, 40, 20, 20, 20];
    ...
    require(msg.value == 500, 'Incorrect Value');
    ...
    startPoolUserCount++;
      ...
      if(startPoolusers[startPooluserList[startPoolactiveUserID]].payment_received>=3){
          startPoolusers[startPooluserList[startPoolactiveUserID]].payment_received=0;
      startPooluserList[startPoolactiveUserID].transfer(300);
    ...
    pool1userList[pool1activeUserID].transfer(600);
    ...
    pool2userList[pool2activeUserID].transfer(1200);
    ...
    pool3userList[pool3activeUserID].transfer(2400);
    ...
    pool4userList[pool4activeUserID].transfer(4800);
    ...
    pool5userList[pool5activeUserID].transfer(9600);
