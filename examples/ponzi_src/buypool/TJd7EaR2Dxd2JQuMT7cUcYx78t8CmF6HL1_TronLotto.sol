...
contract TronLotto {
    ...
    uint pool1_reentry_income = 99; 
    uint pool2_reentry_income = 297; 
    uint pool3_reentry_income = 693; 
    uint pool4_reentry_income = 1485; 
    uint pool5_reentry_income = 3069; 
    uint pool6_reentry_income = 6227; 
    uint pool7_reentry_income = 12573; 
    uint pool8_reentry_income = 25245; 
    uint pool9_reentry_income = 50589; 
    uint pool10_reentry_income = 101277; 
